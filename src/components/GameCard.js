  ...
  return (
    <article className="card gameCard">
      ...
      <div className="buttonArea">
        <button onClick={updater} className="updateButton cardButton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-gear" viewBox="0 0 16 16">
        ...
        <button onClick={deleter} className="deleteButton cardButton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-x-lg" viewBox="0 0 16 16">
